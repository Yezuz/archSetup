...
export PATH=$HOME/.config/composer/vendor/bin:$HOME/bin:/usr/bin:/usr/local/bin:$HOME/.emacs.d/bin:$HOME/.local/bin:$HOME/.local/bin/avd:$HOME/.dotnet/tools:$PATH

# Django variables setup
